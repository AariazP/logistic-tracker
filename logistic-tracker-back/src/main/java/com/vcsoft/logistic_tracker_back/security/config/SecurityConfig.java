package com.vcsoft.logistic_tracker_back.security.config;

import com.vcsoft.logistic_tracker_back.security.filter.JwtAuthenticationFilter;
        ...
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                    ...
                    .requestMatchers("/v3/api-docs/**", "/swagger-ui/**", "/swagger-ui.html").permitAll()
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/packages/**").hasAnyRole("ADMIN", "DRIVER")
                        // DRIVER: update status
                        .requestMatchers(HttpMethod.PATCH, "/api/v1/packages/*/status").hasRole("DRIVER")
