package com.vcsoft.logistic_tracker_back.security.filter;
...
/**
 * Intercepts every request, extracts Bearer token, validates it and sets the
 * Authentication in the SecurityContext. Stateless — no sessions.
 */
@Component
